...
speak("Elder", "No. That's why I wanted to talk to you. My artifact is actually a set of items, magical sending stones that let the owners talk across great distances.")
...
speak("Elder", "The last time I heard from David, he had journeyed to the river city. See if you can find him there. Remember, you'll need all four artifacts to enter Hero.")
