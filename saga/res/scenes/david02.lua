...
speak("David", "Artifacts come in many shapes and sizes. In fact, here's the artifact I already found... the Sending Stone! I have two, so you can keep one as a reward for freeing me.")
...
speak("David", "A woman named Janine gave them to me a long time ago. She said she knew the way to Hero already and didn't need them anymore.")
speak(hero1, "Janine!")

sceneSwitch('borg_leaves_shrine', true)
face('hero', 'SOUTH')

speak("BORG", "That's some news. " .. hero1 .. ", I'd better go tell Elder we've found his sending stone.")
