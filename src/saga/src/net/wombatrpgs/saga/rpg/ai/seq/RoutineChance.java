 ...
 */
package net.wombatrpgs.saga.rpg.ai.seq;

import net.wombatrpgs.saga.rpg.CharacterEvent;
import net.wombatrpgs.saga.rpg.ai.BTNode;
import net.wombatrpgs.saga.rpg.ai.BTSequence;
import net.wombatrpgs.saga.rpg.ai.cond.CondChance;
