...
public class DefaultKeymap extends Keymap {
	...
	/**
	 * @see net.wombatrpgs.saga.io.Keymap#keyDown(int)
	 */
	@Override
	...
	/**
	 * @see net.wombatrpgs.saga.io.Keymap#keyUp(int)
	 */
	@Override
	...
	/**
	 * @see net.wombatrpgs.saga.io.Keymap#isButtonDown
	...
	/**
	 * @see net.wombatrpgs.saga.io.Keymap#replicateButtonUp
	 * (net.wombatrpgs.sagaschema.io.data.InputButton)
	 */
	@Override
	...
	/**
	 * @see net.wombatrpgs.saga.io.Keymap#replicateButtonDown
	 * (net.wombatrpgs.sagaschema.io.data.InputButton)
	 */
	@Override
