 ...
 */
package net.wombatrpgs.saga.io.audio;

import com.badlogic.gdx.assets.AssetManager;
import com.badlogic.gdx.audio.Sound;

import net.wombatrpgs.sagaschema.audio.SoundMDO;
import net.wombatrpgs.sagaschema.audio.data.RepeatType;
...
public class SoundObject extends AudioObject {
	...
	/**
	 * @see net.wombatrpgs.saga.io.audio.AudioObject#corePlay()
	 */
	@Override
	 ...
	 * @see net.wombatrpgs.saga.io.audio.AudioObject#coreStop()
	 */
	@Override
	...
	/**
	 * @see net.wombatrpgs.saga.io.audio.AudioObject#getLoaderClass()
	 */
	@Override
	...
	/**
	 * @see net.wombatrpgs.saga.io.audio.AudioObject#postAudioProcessing
