...
import net.wombatrpgs.saga.scenes.commands.SceneSpeak;
import net.wombatrpgs.saga.scenes.commands.SceneTint;
import net.wombatrpgs.saga.scenes.commands.SceneWait;
...
public class SceneLib extends TwoArgFunction {
	 ...
	 */
	public static List<SceneCommand> parseScene(LuaValue script) {
