...
import net.wombatrpgs.saga.scenes.commands.CommandCameraTrack;
import net.wombatrpgs.saga.scenes.commands.CommandGoToTitle;
import net.wombatrpgs.saga.scenes.commands.CommandMove;
import net.wombatrpgs.saga.scenes.commands.CommandPlayBGM;
import net.wombatrpgs.saga.scenes.commands.CommandPlaySound;
import net.wombatrpgs.saga.scenes.commands.CommandSetGraphic;
import net.wombatrpgs.saga.scenes.commands.CommandSetLocation;
import net.wombatrpgs.saga.scenes.commands.CommandSetSwitch;
import net.wombatrpgs.saga.scenes.commands.CommandShowHide;
import net.wombatrpgs.saga.scenes.commands.CommandSpeakAll;
import net.wombatrpgs.saga.scenes.commands.CommandTeleport;
import net.wombatrpgs.saga.scenes.commands.CommandTint;
import net.wombatrpgs.saga.scenes.commands.CommandWait;
import net.wombatrpgs.saga.scenes.commands.CommandWaitAll;
