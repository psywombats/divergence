 ...
 */
package net.wombatrpgs.mgneschema.graphics;

import net.wombatrpgs.mgneschema.graphics.data.BounceType;
import net.wombatrpgs.mgneschema.graphics.data.EmitterType;
import net.wombatrpgs.mgneschema.graphics.data.ReflectionType;
