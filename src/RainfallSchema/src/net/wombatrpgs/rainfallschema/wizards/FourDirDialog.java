...
public class FourDirDialog extends JDialog implements	ActionListener,
	...
	private static final int DOWN_DIR = 2;
	private static final int UP_DIR = 3;
	...
	private void export() {
		...
		charaMDO.description = "Autogenerated by four dir sprite wizard";
		charaMDO.subfolder = "autogenerated";
		charaMDO.key = "chara_generated_" + name;
		charaMDO.appearance = mdo.key;
		charaMDO.collision = HitboxType.ANIMATION_SPECIFIC_RECTANGLE;
		charaMDO.idleAnim = "None";
		charaMDO.mobility = "mobility_immobile"; // magic value for mobile
		charaMDO.response = CollisionResponseType.IMMOBILE;
		charaMDO.soundHurt = "None";
		charaMDO.touch = TouchEffectType.NOTHING;
		frame.getLogic().getOut().writeNewSchema(charaMDO);
		
		JOptionPane.showMessageDialog(this,
				"Export complete.\n" +
					"To test this sprite on a map, make an event with the "+
					"property \"key\" and value \"" + charaMDO.key + "\".",
				"Export Complete",
