...
import net.wombatrpgs.rainfallschema.characters.hero.moveset.DummyAttackMDO;
...
public class MoveFactory {
	...
	public static MovesetAct generateMove(CharacterEvent actor, String moveKey) {
		...
		} else if (DummyAttackMDO.class.isAssignableFrom(moveMDO.getClass())) {
			act = new ActDummyAttack(actor, (DummyAttackMDO) moveMDO);
		} else {
